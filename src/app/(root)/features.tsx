...
const Features = () => {
  ...
  return (
    <section className="h-fit hidden md:flex flex-col gap-5 py-20 items-center rounded-lg">
      <div className="text-center font-bold text-4xl space-y-5">
        <h1>단계에 맞춰 꼼꼼하게</h1>
        <h1>
      ...
      <div className="mt-10 h-[35rem] w-[80%] mx-auto relative">
